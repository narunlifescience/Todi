...
class MPDDatabaseConnection : public MPDConnection {
 ...
 public:
  MPDDatabaseConnection(QObject *parent = nullptr);
  MPDDatabaseConnection(const QString &host, const quint16 port,
 ...
 signals:
  void musicLibraryUpdated(QList<MusicLibraryItemArtist *> *items,
                           QDateTime db_update);
