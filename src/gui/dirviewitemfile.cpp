...
DirViewItemFile::DirViewItemFile(const QString name, DirViewItem *parent)
    : DirViewItem(name, DirViewItem::Type_File), d_parentItem(parent) {}
  ...
  switch (d_parentItem->type()) {
    case DirViewItem::Type_Root:
      return static_cast<DirViewItemRoot *>(d_parentItem)
          ->d_childItems.indexOf(const_cast<DirViewItemFile *>(this));
...
DirViewItem *DirViewItemFile::parent() const { return d_parentItem; }
