...
MusicLibraryModel::~MusicLibraryModel() { delete rootItem; }

QModelIndex MusicLibraryModel::index(int row, int column,
...
QVariant MusicLibraryModel::headerData(int section, Qt::Orientation orientation,
                                       int role) const {
...
void MusicLibraryModel::updateLibrary(QList<MusicLibraryItemArtist *> *items,
 ...
 */
QStringList MusicLibraryModel::sortAlbumTracks(
